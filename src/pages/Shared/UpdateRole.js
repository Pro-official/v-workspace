              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="relative z-0 col-span-2">
                  <select
                    ...
                    rows="5"
                    ref={typeRef}
                    className="peer block w-full appearance-none border-0 border-b border-[#163A24] bg-transparent py-2.5 text-sm text-gray-900 focus:border-[#163A24] focus:outline-none focus:ring-0"
                    placeholder=""
