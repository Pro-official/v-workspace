              ...
              person.type ? (
                ...
                <div className="flex min-h-screen items-center justify-start bg-white">
                  <div className="mx-auto w-full max-w-lg">
                    ...
                    <p className="mt-3">
                      Register yourself as a student, teacher or industry expart
                      to get more personalised options
                    </p>
                    <form
                      ...
                      <div className="grid gap-6 sm:grid-cols-2">
                        ...
                        <div className="relative z-0 col-span-2">
                          ...
                          <p className="mt-4 font-light text-sm">
                            Select your user type. Once you select and update
                            your profile, you have to visit{" "}
