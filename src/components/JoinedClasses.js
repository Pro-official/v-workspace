                  ...
                  .map((cl) => (
                    <>
                      {cl.classInfo ? (
                        ...
                        <div className="container md:max-w-7xl mx-auto text-center">
                          <h1 className="text-2xl text-[#163A24] font-bold mt-20 ">
                            No joined Classes to show.
                            <span className="ml-4 border-2 p-2 bg-[#163A24] text-white rounded-lg">
